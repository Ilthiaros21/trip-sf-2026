...
## Estado
App con estética ref1 (pastel, Familjen/Hanken, liquid glass en nav) + spine continuo por categoría con reveal de scroll + tarjetas 3D + hotel Aloft Sunnyvale + Itinerario granular sin resumen de día + Info práctica de 4 tabs, en producción vía GitHub Pages. Docs sincronizados.
